...
@call_decorator({'x': {}}, is_attr=False)
def _len(vm, x: Node):
    try:
...
@call_decorator({'x': {}}, is_attr=False, req_vm=False)
def _attrs(x: Node):
...
@call_decorator({'obj': {}, 'name': {'type': 'string'}}, is_attr=False)
...
@call_decorator({'obj': {}, 'name': {'type': 'string'}, 'value': {}}, is_attr=False, req_vm=False)
